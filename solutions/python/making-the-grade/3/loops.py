...
def letter_grades(highest: int) -> list[int]:
    ...
    :return: list - of lower threshold scores for each D-A letter grade interval.
            ...
            86 <= "A" <= 100
    """
    range_threshold = round((highest-FAIL_SCORE)/4)

    letter_grades_threshold = []

    for score in range(FAIL_SCORE+1, highest, range_threshold):
        letter_grades_threshold.append(score)

    return letter_grades_threshold
